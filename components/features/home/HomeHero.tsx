export function HomeHero() {
	return (
		<div className='mx-auto max-w-2xl space-y-3 py-2 text-center sm:py-4'>
			...
			<h1 className='text-3xl leading-tight font-extrabold tracking-tight text-[#1A1A1A] sm:text-4xl md:text-5xl'>
				Готовьте из того, <br />
				<span className='text-[#E95B3C]'>что уже есть</span> дома
			</h1>
